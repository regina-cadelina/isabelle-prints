...
// Fetch order items - including selected_size and selected_color
$stmt = $pdo->prepare("
    SELECT oi.*, p.name AS product_name, oi.selected_size, oi.selected_color
    FROM order_items oi
    LEFT JOIN products p ON oi.product_id = p.id
    WHERE oi.order_id = ?
");
                        ...
                        <div class="order-summary-body">
                            <div class="order-info-grid">
                                ...
                                <div class="order-info-item">
                                    ...
                                    <div class="order-info-value">
                                        <?php
                                            $sizes = array_filter(array_map(fn($item) => $item['selected_size'] ?? null, $items));
                                            if (!empty($sizes)) {
                                                echo htmlspecialchars(implode(', ', $sizes));
                                            } else {
                                                echo '<span style="color:#888;">Not specified</span>';
                                            }
                                        ?>
                                    </div>
                                </div>
                                ...
                                <div class="order-info-item">
                                    ...
                                    <div class="order-info-value">
                                        <?php
                                            $colors = array_filter(array_map(fn($item) => $item['selected_color'] ?? null, $items));
                                            if (!empty($colors)) {
                            ...
                            <table class="order-items-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="price-cell">₱<?php echo number_format($item['unit_price'], 2); ?></td>
                                        <td class="price-cell">₱<?php echo number_format($item['unit_price'] * $item['quantity'], 2); ?></td>
                                        <td><?php echo !empty($item['selected_size']) ? htmlspecialchars($item['selected_size']) : '<span style="color:#888;">-</span>'; ?></td>
                                        <td><?php echo !empty($item['selected_color']) ? htmlspecialchars($item['selected_color']) : '<span style="color:#888;">-</span>'; ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
